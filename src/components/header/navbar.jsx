      ...
      {!loggedInState ? (
        <ul className="text-rose-900 flex flex-row justify-between gap-2 w-full items-center m-auto flex-wrap min-h-[4.5rem] md:flex-wrap min-h-[3rem] s:min-h-[2rem]">
          <li className="m-auto">
            ...
            isActive ? "text-secondary font-bold bg-tertiary rounded-[25px] p-4 border-2 border-secondary lg:p-2 font-semibold lg:rounded-[15px] s:text-[0.7rem] p-0 rounded-[13px]" : "text-secondary font-bold bg-tertiary rounded-[25px] p-4 lg:p-2 font-semibold lg:rounded-[15px] s:text-[0.7rem] p-0 rounded-[13px]"}>
              Home
            </NavLink>
          </li>
          <li className="m-auto">
