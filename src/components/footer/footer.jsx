...
function Footer() {
    return (
        <footer className="flex flex-row justify-between mx-auto items-center w-full mb-2 lg:flex-col gap-2">
            ...
            <a href="mailto:contact@holidaze.no" title="Link to email Holidaze" className="text-black underline font-semibold text-center w-1/3 lg:w-1/2 md:w-2/3 s:w-full">Contact@holidaze.no</a>
